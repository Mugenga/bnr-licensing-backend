...
async function deliver(application, template) {
  try {
    ...
    // Try sending email, but never throw back into workflow.
    ...
    // Notification failure should only be logged, not break application action.
...
// Pending approval is internal, applicant does not need email yet.
